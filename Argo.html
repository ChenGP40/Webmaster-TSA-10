...
<div class="reveal fadeIn" style="background-color: black;">
	<img src="Argo2.png" style="max-height: 100vh; filter: blur(3px); padding-bottom: 2em;" alt="The Argo">
	<div class="imageText text">The Argo</div>
</div>
<br/><br/><br/>
<div class="boxinfo">
	<div>
		<span style="border-bottom:#FF530D 5px solid;">Introducing: The Argo</span>
	</div>
	<div>
