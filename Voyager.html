...
<div class="reveal fadeIn" style="background-color: black;">
	<img src="Voyager2.png" style="max-height: 100vh; filter: blur(3px); padding-bottom: 2em;" alt="The Voyager">
	<div class="imageText text">The Voyager</div>
</div>
<br/><br/><br/>
<div class="boxinfo reveal fadeIn">
	<div>
		<span style="border-bottom:#FF530D 5px solid;">Introducing: The Voyager</span>
	</div>
	<div>
